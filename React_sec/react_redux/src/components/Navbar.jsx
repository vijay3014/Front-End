        ...
        <div className="sticky top-0 w-full bg-white">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
                <div className="inline-flex items-center space-x-2">
                    <span>
                    <img src="https://static.vecteezy.com/system/resources/previews/011/225/028/original/letter-uv-logo-design-uv-logo-with-square-shape-in-black-colors-free-template-free-vector.jpg" alt="" className='rounded-full h-20 w-20' />
                    </span>
                    <NavLink to='/' className="font-bold"></NavLink>
                </div>
                        ...
                        {menuItems.map((item) => (
                            <li key={item.name}>
                                <NavLink
                                    ...
                                    className={({ isActive }) =>
                                        isActive
                                            ? "text-sm font-semibold text-[#b233ff] underline "
                                            : "text-sm font-semibold text-gray-800 hover:text-[#9633ff]"
                                    }
                                >
                                    {item.name}
                                </NavLink>
